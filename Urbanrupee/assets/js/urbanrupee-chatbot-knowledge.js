/* Urbanrupee chatbot knowledge — generated by scripts/build-chatbot-knowledge.mjs */
(function (global) {
  "use strict";
  if (!global) return;
  global.__URBANRUPEE_CHATBOT_KB__ = [
  {
    "k": [
      "what is urbanrupee",
  ...
  },
  {
    ...
    "a": "Urbanrupee's Close Route Wallet is a controlled wallet product for programmes that need balances, transfers, and spends to stay on approved paths only—paired with policies, ledgers, and APIs so you can run loyalty, marketplace, or B2B wallet flows with clear auditability."
  },
  {
    "k": [
      "how does the aml",
  ...
  {
    "k": [
      "customize hyper checkout",
      "hyper checkout customized",
      "hyper checkout customize"
    ],
